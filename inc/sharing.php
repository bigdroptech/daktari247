        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="page-scroll" href="#page-top" href="#home">Home</a>
                    </li>
                    <li>
                        <a class="" href="feeds.php">Feeds</a>
                    </li>
                     <li>
                    ...
                    <li>
                        ...
                        if(isset($_SESSION['username'])) {
                          ...
                          echo '<li>
                                <a href="config/logout.php" id="logout"><span class="glyphicon glyphicon-off" aria-hidden="true" title="Logout"></span></a></li>';
                        } else {
                                echo '<li>
