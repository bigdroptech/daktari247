            ...
            <div class="s-results col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <?php
                    ...
                    if (isset($_GET['article'])){
                            ...
                            $feed_id = $_GET['article'];


                    $query="SELECT id, fd_dr_id, name, image, status, dr_image_url as profile_pic, time_stamp, url, usr_id, js_his.getpersname(fd_dr_id) 
                    as dr_name, spname as dr_specialization, dr_count_like FROM js_core.m_feeds,js_core.m_doctors,js_core.m_common_specialities 
                    where dr_id=fd_dr_id and spid=dr_spid and id='$feed_id'";
                        ...
                        while ($row = pg_fetch_assoc($result)) {
                                    echo '<div class="feedResults col-md-12 col-lg-12 col-sm-12 col-xs-12">';
                                        echo '<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 paddingFeeds">';
                                            ...
                                            echo '<div class="row">';
                                                echo '<div class="col-md-12 col-lg-12 imgHeightArticle">';
                                                    if (($row['image']) != "null"){
